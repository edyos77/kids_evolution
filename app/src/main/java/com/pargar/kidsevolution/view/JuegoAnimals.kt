...
import com.pargar.kidsevolution.databinding.FragmentJuegoAnimalsBinding

class JuegoAnimals : AppCompatActivity() {
    /*
     * TODO cancion cuando ganas
     * registrar actividad en el manifest
     */

    private lateinit var binding: FragmentJuegoAnimalsBinding
    ...
    private val nombreFrutasMap = mapOf(
        R.drawable.caballo to "caballo",
        R.drawable.conejo to "conejo",
        R.drawable.vaca to "vaca",
        R.drawable.cerdo to "cerdo",
        R.drawable.gallina to "gallina",
        R.drawable.oveja to "oveja"
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = FragmentJuegoAnimalsBinding.inflate(layoutInflater)
